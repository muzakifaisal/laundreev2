...
?>
            ...
            <div class="box-header with-border">
              ...
              <div class="box-body">
				...
				<div class="form-group">
				 <label for="checkbox" class="col-sm-3 control-label">Responsive</label>
                  <div class="col-sm-9">
                    <div class="checkbox">
                      <label>
					  <?php if($checkbox == '0'){?>
          ...
          <div class="form-group">
            <label for="print" class="col-sm-3 control-label">Template Struk</label>
            <div class="col-sm-9">
              <select class="form-control select2" style="width: 100%;" name="print">
                <option value='one' <?php if($print == 'one'){echo 'selected';}?>>Printer Kasir 57/58/59 ++</option>
                <option value='two' <?php if($print == 'two'){echo 'selected';}?>>Printer Inkjet/Deskjet A4/F4</option>
              </select>
            </div>
          </div>
	...
	if(!isset($_POST["checkbox"])){
		$checkbox = '1';
              ...
              if(mysqli_num_rows($result)>0){
				   ...
				   $sql1 = "update backset set url='$url', sessiontime='$session', footer='$footer', responsive='$checkbox', print='$print'";
				     $result = mysqli_query($conn, $sql1);
             echo "<script type='text/javascript'>  alert('Berhasil, Data telah disimpan!'); </script>";
             echo "<script type='text/javascript'>window.location = 'set_general';</script>";
			  }else{
                $sql1 = "insert into backset (url,sessiontime,footer,responsive) values('$url','$session','$footer','$checkbox','$print')";
			        $result = mysqli_query($conn, $sql1);
              echo "<script type='text/javascript'>  alert('Berhasil, Data telah disimpan!'); </script>";
              echo "<script type='text/javascript'>window.location = 'set_general';</script>";
			  }
