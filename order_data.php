...
?>
    ...
    if($deadline != null){
    $sql    = "select * from $forward where tgldeadline ='$deadline' order by no desc";
  }else if($deadline == null && $date != null){
    $sql    = "select * from $forward where tglmasuk ='$date' order by no desc";
    }else{
					...
					?>
                     <tbody>
                       ...
                       <?php }else if($fill['status'] == 'selesai'){ ?>
                         ...
                         <?php	if ($chmod >= 3 || $_SESSION['jabatan'] == 'admin') { ?>
                           <?php if($fill['status']=='proses'){?>
                             <button type="button" class="btn btn-success btn-xs no-print btn-flat" style="width:55px" onclick="window.location.href='component/setting/status_master?status=<?php echo 'selesai'.'&';?>no=<?php echo $fill['no'].'&'; ?>forward=<?php echo $forward.'&';?>forwardpage=<?php echo $forwardpage.'&'; ?>chmod=<?php echo $chmod.'&'; ?>page=<?php echo $page; ?>'">Selesai</button>
                             <?php }else if($fill['status']=='selesai'){ ?>
                               <button type="button" class="btn btn-danger btn-xs no-print btn-flat" style="width:55px" onclick="window.location.href='component/setting/status_master?status=<?php echo 'lunas'.'&';?>no=<?php echo $fill['no'].'&'; ?>forward=<?php echo $forward.'&';?>forwardpage=<?php echo $forwardpage.'&'; ?>chmod=<?php echo $chmod.'&'; ?>page=<?php echo $page; ?>'">Lunas</button>
                           <?php } ?>
