...
if ($chmod >= 2 || $_SESSION['jabatan'] == 'admin') {
    ...
    if(isset($_POST["tambah"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
              ...
              $layanan = mysql_real_escape_string($_POST["layanan"]);
              ...
              $biayaakhir = mysql_real_escape_string($_POST["biaya"]*$_POST["jumlah"]);
              $insert = ($_POST["insert"]);
    ...
    if(isset($_POST["simpan"])){
       if($_SERVER["REQUEST_METHOD"] == "POST"){
              ...
              if($pelanggan == null || $pelanggan == ""){
                $pelanggan = mysql_real_escape_string('1');
              }else{
                $pelanggan = mysql_real_escape_string($_POST["pelanggan"]);
              }
              $tgldeadline = mysql_real_escape_string($_POST["tgldeadline"]);
              $jamdeadline = mysql_real_escape_string($_POST["jamdeadline"]);
            ...
            $result=mysqli_query($conn,$sql);
               ...
               $sql2 = "insert into bayar values( '$kode','$tglnota','$jammasuk','$pelanggan','$datatotal','$tgldeadline','$jamdeadline','proses','$kasir','$catatan','','')";
               $insertan = mysqli_query($conn, $sql2);
	 ...
	 <div class="container-fluid">
          ...
          <form class="form-horizontal" method="post" action="add_<?php echo $halaman; ?>" id="Myform" class="form-user">
            ...
            $datae=$hasil['nama'];
    			...
    			if ($layanan==$row['kode']){
    			echo "<option value='".$row['kode']."' nama='".$row['nama']."' satuan='".$datae."' biaya='".$row['biaya']."' selected='selected'>".$row['nama']." | ".$row['kode']."</option>";
        }else{
    			echo "<option value='".$row['kode']."' nama='".$row['nama']."' satuan='".$datae."'  biaya='".$row['biaya']."' >".$row['nama']." | ".$row['kode']."</option>";
    		}
      }
    	?>
                    </select>
        ...
        <div class="col-md-6">
          <div class="box box-danger">
           ...
           <td><?php  echo mysql_real_escape_string($fill['jumlah'].' '.$fill['satuan']); ?></td>
           <td><?php  echo mysql_real_escape_string(number_format(($fill['jumlah']*$fill['biaya']), $decimal, $a_decimal, $thousand).',-'); ?></td>
           <td>
                                ...
                                <div class="box box-solid">
                                    ...
                                    <div class="row" >
                                       <div class="form-group col-md-6 col-xs-12" >
                                		...
                                		while ($row=mysqli_fetch_assoc($sql)){
                                			...
                                			echo "<option value='".$row['kode']."' nama='".$row['nama']."' selected='selected'>".$row['nama']." | ".$row['kode']."</option>";
                                    }else{
                                			echo "<option value='".$row['kode']."' nama='".$row['nama']."' >".$row['nama']." | ".$row['kode']."</option>";
                                		}
                                  }
                                	?>
                                                </select>                                              </div>
                                       ...
                                       <div class="form-group col-md-6 col-xs-12" >
                                              ...
                                              <div class="col-sm-5">
                                                <input type="text" class="form-control pull-right" id="datepicker3" name="tgldeadline" placeholder="Contoh : <?php echo date("Y-m-d");?>" value="<?php echo $tgldeadline; ?>" >
                                              </div>
                                              <div class="col-sm-5">
                                                <input type="text" class="form-control" id="jamdeadline" name="jamdeadline" value="<?php echo $jamdeadline; ?>" maxlength="5" placeholder="Contoh : <?php echo date("H:i");?>">
 </div>
                                  ...
                                  <div class="row" >
                                    <div class="form-group col-md-12 col-xs-12" >
                                           ...
                                           <div class="col-sm-11">
                                             <textarea class="form-control" rows="1" maxlength="255" name='catatan' id='catatan' placeholder="Masukan Catatan yang diperlukan, gunakan enter bila catatan panjang"><?php echo $catatan; ?></textarea>
                                           </div>
                                         </div>
                                  </div>
                              </div>
